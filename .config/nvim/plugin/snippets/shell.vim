...
au automation FileType sh,conf,yaml,sxhkd,zsh,python,muttrc,tmux inoremap ;b #<esc>79a=<esc>yypO#<esc>30a<space><Esc>i
au automation FileType sh,conf,yaml,sxhkd,zsh,python,muttrc,tmux inoremap ;B #<esc>39a=<esc>yypO#<esc>15a<space><Esc>i
