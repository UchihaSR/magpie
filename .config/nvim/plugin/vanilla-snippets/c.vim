...
au automation FileType c inoremap ;p printf("");<esc>3<left>a
au automation FileType c inoremap ;s system("");<esc>3<left>a
au automation FileType c inoremap ;i #include 
...
au automation FileType c,javascript inoremap ;b //<esc>78a=<esc>yypO//<esc>30a<space><Esc>i
au automation FileType c,javascript inoremap ;B //<esc>38a-<esc>yypO//<esc>15a<space><Esc>i
